...
clang -std=c++17 -m64 -g ../src/win32_main.cpp -o ./main.exe -I../src  -I../libs/sdl/include -L ../libs/sdl/libs -lshell32.lib -lSDL2main -lSDL2 -fwritable-strings -Werror -fno-exceptions -Wl,/PDB:game_%SUBFILENAME%.pdb -Xlinker -subsystem:windows
del lock.tmp
